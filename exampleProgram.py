...
print("\nA cylinder with radius 5 and height 6 has volume", cylinderV, "and surface area ", cylinderSA)

#Calculating for rectangular prism with length 6, width 5, height 7
rpV, rpSA = geoCalc.rectangularPrism(6,5,7)
print("\nA rectangular prism with length 6, width 5, height 7, has volume", rpV, "and surface area ", rpSA)

#Calculating for cone with radius 4, height 7
coneV, coneSA = geoCalc.cone(4,7)
print("\nA cone with radius 4 and height 7 has volume", coneV, "and surface area", coneSA)
